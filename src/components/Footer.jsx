      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold">Event Horizon</h3>
            <p className="text-gray-400">
              Bringing people together through unforgettable experiences and creating memories that last a lifetime.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Music Concerts</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-start space-x-3">
                ...
                <p>123 Event Street, Downtown, City 10001</p>
              </div>
              <div className="flex items-center space-x-3">
                <MdEmail size={20} />
                <a href="mailto:info@eventhorizon.com" className="hover:text-white transition-colors">
